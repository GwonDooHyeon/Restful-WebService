package kr.co.study.restfulservice.bean;
...
public class User {
    @Schema(title = "사용자 ID", description = "사용자 ID는 자동 생됩니다.")
    private Integer id;
    ...
    @Schema(title = "사용자 등록일", description = "사용자 등록일을 입력합니다. 입력하지 않으면 현재 날짜가 입력됩니다.")
